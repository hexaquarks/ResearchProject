...
class Nanodomain(Simulation):
    ...
    NANODOMAIN_DIFFUSION_FATOR_CORRECTED = MEMBRANE_DIFFUSION_FATOR_CORRECTED * 0.3
    ...
    def update_path(self, idx):
        ...
        diffusion_factor = NANODOMAIN_DIFFUSION_FATOR_CORRECTED if (is_particle_in_nanodomain(self, (x, y))) else MEMBRANE_DIFFUSION_FATOR_CORRECTED
